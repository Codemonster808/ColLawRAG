...
const COLOQUIAL_TO_LEGAL: Record<string, string[]> = {
  ...
  // Tributario (Sprint 4 S4.3: +30 términos específicos)
  'impuestos': ['tributos', 'obligación tributaria', 'impuesto de renta'],
  'dian': ['Dirección de Impuestos y Aduanas Nacionales', 'autoridad tributaria', 'sanción DIAN'],
  'renta': ['impuesto sobre la renta', 'declaración de renta', 'renta líquida'],
  'iva': ['impuesto sobre las ventas', 'IVA', 'tarifa general', 'hecho generador IVA', 'hecho generador'],
  ...
  'declaracion': ['declaración tributaria', 'obligación fiscal', 'vencimiento'],
  'exención': ['beneficio tributario', 'exención fiscal', 'no gravado', 'tarifa 0%'],
  'exencion': ['exención fiscal', 'no gravado', 'beneficio tributario'],
  'retención': ['retención en la fuente', 'agente retenedor', 'retención fiscal', 'autorretenedor'],
  'retencion': ['retención en la fuente', 'agente retenedor', 'autorretenedor'],
  ...
  'gravamen': ['hecho generador', 'objeto del impuesto', 'base gravable'],
  'contribuyente': ['obligado tributario', 'sujeto pasivo', 'responsable fiscal'],
  'fiscalizacion': ['fiscalización tributaria', 'control DIAN', 'revisión de declaración'],

  // Penal (Sprint 4 S4.3: +20 términos específicos)
  'robo': ['hurto', 'apoderamiento', 'delito contra el patrimonio', 'Art. 239 CP'],
  'hurto': ['delito de hurto', 'Art. 239 CP', 'apoderamiento ilícito'],
  'golpear': ['lesiones personales', 'violencia', 'agresión', 'Art. 111 CP'],
  'matar': ['homicidio', 'delito contra la vida', 'Art. 103 CP'],
  'homicidio': ['delito contra la vida', 'Art. 103 CP', 'homicidio simple', 'homicidio agravado'],
  ...
  'prescripcion': ['prescripción acción penal', 'término prescriptivo', 'extinción'],
  ...
  'dosificacion': ['dosificación pena', 'atenuantes', 'agravantes'],
  ...
  'apelacion': ['recurso de apelación', 'segunda instancia', 'impugnación'],
  'casación': ['recurso de casación', 'recurso extraordinario', 'Corte Suprema de Justicia'],
  'casacion': ['recurso de casación', 'recurso extraordinario', 'Corte Suprema'],
  ...
  'notificacion': ['notificación personal', 'comunicación oficial', 'edicto'],
  'término': ['plazo procesal', 'término legal', 'tiempo procesal', 'término de traslado'],
  'termino': ['plazo procesal', 'término legal', 'tiempo procesal'],
  ...
  'contestacion': ['contestación demanda', 'respuesta demanda', 'excepciones'],
