    ...
    try {
      ...
      try {
        ...
        const historyItem = {
          ...
          query,
          legal_area: data.legal_area || undefined,
        ...
        console.warn('No se pudo guardar en historial local:', e)
      }
    } catch (e: any) {
      setError(e.message || 'Error inesperado')
      // Guardar consulta fallida en historial
      try {
        const historyItem = {
      ...
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-10">
        <header className="mb-8">
            ...
            <div className="flex items-center gap-4">
              <Link href="/historial" className="text-sm text-gray-600 hover:text-gray-900 font-medium">
                Historial
              </Link>
