...
import { generatePrompts, type PromptContext } from '@/contexts/legal-search/infrastructure/llm/PromptTemplates'
import { logger } from '@/shared/utils/Logger'
import { validateHNACStructure, generateHNACErrorFeedback, type HNACValidationResult } from '@/contexts/answer-quality/domain/services/HnacValidatorService'
...
export async function generateAnswerSpanish(params: {
  ...
  const { query, chunks, legalArea, includeWarnings = true, requestId, complexity = 'media', enforceHNAC = true, usePromptByArea } = params
